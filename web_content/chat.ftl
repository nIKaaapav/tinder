            ...
            <div class="col-md-12 chat-header">
                <div class="row header-one text-white p-1">
                    <div class="col-md-6 name pl-2">
                        ...
                        <h6 class="ml-1 mb-0">${userChat}</h6>
                    </div>
                ...
                <div class="col-md-12 chats pt-3 pl-2 pr-3 pb-3">
                    <ul class="p-0">
                        <#list messages as item>
                            <#if item.getUserFrom().getId() == currentUser>
                            ...
                            <#else>
                                <li class="receive-msg float-left mb-2">
                                    <div class="sender-img">
                                        <img src=${item.getUserFrom().getUrlImg()} class="float-left">
                                    </div>
                                    <div class="receive-msg-desc float-left ml-2">
                                        <p class="bg-white m-0 pt-1 pb-1 pl-2 pr-2 rounded">
                                            ${item.getMessageText()}
                                        </p>
                                        <span class="receive-msg-time">${item.getUserFrom().getName()}, {item.getData()}</span>
                                    </div>
                                </li>
                            </#if>
                        </#list>
                ...
                <div class="col-md-12 p-2 msg-box border border-primary">
                    <div class="row">
                        ...
                        <div class="col-md-7 pl-0">
                            <form method="post">
                                <input type="text" name="msg" class="border-0" placeholder=" Send message" />
                            </form>
                        </div>
